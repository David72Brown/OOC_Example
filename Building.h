...
#define CLASS_DATA(v)
#define CLASS_METHOD_0(ReturnType, MethodName)													extern ReturnType Building_##MethodName (tBuilding *pObj);
#define CLASS_METHOD_1(ReturnType, MethodName, ParamType1, ParamName1)							extern ReturnType Building_##MethodName (tBuilding *pObj, ParamType1 ParamName1);
#define CLASS_METHOD_2(ReturnType, MethodName, ParamType1, ParamName1, ParamType2, ParamName2)	extern ReturnType Building_##MethodName (tBuilding *pObj, ParamType1 ParamName1, ParamType2 ParamName2);
#include "BuildingClass.h"
