...
#define CLASS_DATA(v)
#define CLASS_METHOD_0(ReturnType, MethodName)													extern ReturnType HighSchool_##MethodName (tHighSchool *pObj);
#define CLASS_METHOD_1(ReturnType, MethodName, ParamType1, ParamName1)							extern ReturnType HighSchool_##MethodName (tHighSchool *pObj, ParamType1 ParamName1);
#define CLASS_METHOD_2(ReturnType, MethodName, ParamType1, ParamName1, ParamType2, ParamName2)	extern ReturnType HighSchool_##MethodName (tHighSchool *pObj, ParamType1 ParamName1, ParamType2 ParamName2);
#include "HighSchoolClass.h"
